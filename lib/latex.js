...
const { ROUND_NAMES } = require('./rounds');
...
async function generateLatexContent(questions, round, subjectOrder, counts) {
	const grouped = {};
...
async function generateReplacementsLatexContent(questions, round, subjectOrder) {
	const grouped = {};
	for (const subject of subjectOrder) {
