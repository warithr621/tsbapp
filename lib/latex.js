...
function buildPreamble(round, title, writers = {}, subjectOrder = []) {
...
async function generateLatexContent(questions, round, subjectOrder, counts, writers = {}) {
	const grouped = {};
	...
	let content = buildPreamble(round, ROUND_NAMES[round], writers, subjectOrder);
...
async function generateReplacementsLatexContent(questions, round, subjectOrder, writers = {}) {
	const grouped = {};
	for (const subject of subjectOrder) {
	...
	let content = buildPreamble(round, `${ROUND_NAMES[round]} (Replacements)`, writers, subjectOrder);
